 ...
 */
export function logMessage(message: string, { extras } = DefaultExtrasParameters): void {
 ...
 * @param extras - a set of additional values that may be useful for the client when logging the message.
 */
export function logWarning(message: string, { extras } = DefaultExtrasParameters): void {
 ...
 * @param extras - a set of additional values that may be useful for the client when logging the message.
 */
export function logFatal(message: string, { extras } = DefaultExtrasParameters): void {
